...
export default function Projects() {
  const projects = [
    ...
    {
      id: "2",
      img: "/images/ecosus.jpg",
      title: "Ecosus Construction & Design",
      live: "https://ecosus.com.sa/",
      source: "https://github.com/ibrahimezzat3/const",
      category: "business",
      difficulty: "advanced",
      tech: [
        "React 18",
    ...
    },
    {
      ...
      description:
        "Fullstack real-time chat and video calling platform with 1-on-1 and group calls, screen sharing, recording, typing indicators, reactions, JWT authentication, 32 UI themes, error handling, and scalable deployment.",
    },
    {
      id: "5",
